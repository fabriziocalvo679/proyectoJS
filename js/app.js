...
let sizeIndicador = menu.querySelector ('a').offsetWidth;

indicador.style.width = sizeIndicador + 'px';
...
const observer = new IntersectionObserver( (entradas)=> {
    ...
    if (entrada.isIntersecting){
        ...
        indicador.style.transform = `translateX(${sizeIndicador*indexSeccionActiva}px)`
        }
    })
} , { 
...
const onRezise = () => {
    sizeIndicador = menu.querySelector ('a').offsetWidth;
    indicador.style.width = `${sizeIndicador}px`
    indicador.style.transform = `translateX(${sizeIndicador*indexSeccionActiva}px)`
}
